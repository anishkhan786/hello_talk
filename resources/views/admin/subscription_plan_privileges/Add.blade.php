                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Plan Privilege </a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{ route('subscription_plan_privileges.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="privilege" class="form-control" name="privilege_id" required>
                                                        ...
                                                        @foreach($privileges as $id => $name)
                                                            <option value="{{ $id }}" {{ old('privilege_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="access_type" class="form-control" name="access_type" required>
                                                        ...
                                                        @foreach($accessTypes as $type)
                                                            <option value="{{ $type }}" {{ old('access_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="limit_value" class="form-control" 
                                                        name="limit_value" placeholder="Enter Limit Value" value="{{ old('limit_value') }}">
