                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('questions-edit.update', $question->id) }}">
                                        @csrf
                                        <div class="row">
                                             <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="topic_id"  class="form-control" required>
                                                        ...
                                                        @foreach($topic as $t)
                                                        <option value="{{$t->id}}"  {{ $question->topic_id===$t->id?'selected':'' }}>{{$t->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('topic_id')
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-column" class="form-control"
                                                        placeholder="Title" name="title"  value="{{ old('title', $question->title) }}" required/>
                                                         @error('title')
                                                        <p class='text-danger text-xs pt-1'> {{ $message }} </p>
                                                    @enderror
                                                </div>
                                                         ...
                                                         @foreach($question->options as $i => $opt)
                                                            <div class="input-group mb-2 option-row">
                                                                ...
                                                                <div class="input-group-text">
                                                                    ...
                                                                    <input type="checkbox" name="options[{{ $i }}][is_correct]" {{ $opt->is_correct ? 'checked' : '' }}>
